...
static std::string genericError400 =
    R"({
  "errors": [
    {
...
static std::string genericError401 =
    R"({
  "errors": [
    {
      "status": "401",
...
static std::string genericError404 =
    R"({
  "errors": [
    {
      "status": "404",
...
static std::string genericError500 =
    R"({
  "errors": [
    {
      "id": "0be22ae7-efdf-44d9-99f4-f138049d76ca",
...
static std::string postErrorInvalidClient =
    R"({
