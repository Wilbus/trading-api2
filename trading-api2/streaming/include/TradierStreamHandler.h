...
class TradierStreamHandler : public IStreamHandler
{
public:
    TradierStreamHandler(std::string url, std::set<std::string> product_ids, std::string seshId);
    TradierStreamHandler(std::string url);
    ~TradierStreamHandler();
