...
public:
    ...
    MOCK_METHOD2(
        mycurl_easy_setopt_writefunction, CURLcode(CURL*, std::function<size_t(void*, size_t, size_t, void*)>));
    MOCK_METHOD2(mycurl_easy_setopt_verbose, CURLcode(CURL*, bool));
    MOCK_METHOD2(mycurl_easy_setopt_writedata, CURLcode(CURL*, std::string&));
